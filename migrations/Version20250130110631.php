 ...
 */
final class Version20250130110631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contactez_nous (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, tel VARCHAR(20) NOT NULL, objet VARCHAR(255) NOT NULL, message LONGTEXT DEFAULT NULL, nom VARCHAR(254) NOT NULL, prenom VARCHAR(254) NOT NULL, dateDenvoie DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('DROP TABLE contactez-nous');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contactez-nous (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(254) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, prenom VARCHAR(254) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, email VARCHAR(50) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, tel VARCHAR(50) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, objet VARCHAR(50) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`, message TEXT CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, dateDenvoie DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET latin1 COLLATE `latin1_swedish_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('DROP TABLE client');
        $this->addSql('DROP TABLE contactez_nous');
