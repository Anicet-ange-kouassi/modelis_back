 ...
 */
final class Version20250121002926 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP paysId, CHANGE pays_id pays_id INT NOT NULL, CHANGE adresse adresse LONGTEXT NOT NULL, CHANGE dateModification dateModification DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE dateSuppression dateSuppression DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE typeclient ADD date_creation DATETIME NOT NULL, DROP dateCreation, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE image image LONGTEXT DEFAULT NULL, CHANGE description description LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP FOREIGN KEY FK_4C62E638A6E44244');
        $this->addSql('ALTER TABLE contact ADD paysId INT NOT NULL, CHANGE pays_id pays_id INT DEFAULT NULL, CHANGE adresse adresse TEXT NOT NULL, CHANGE dateModification dateModification DATETIME DEFAULT NULL, CHANGE dateSuppression dateSuppression DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE contact ADD CONSTRAINT FK_4C62E638A6E44244 FOREIGN KEY (pays_id) REFERENCES pays (id) ON UPDATE NO ACTION ON DELETE SET NULL');
        ...
        $this->addSql('ALTER TABLE typeclient ADD dateCreation DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, DROP date_creation, CHANGE id id INT NOT NULL, CHANGE image image TEXT DEFAULT NULL, CHANGE description description TEXT DEFAULT NULL');
