 ...
 */
final class Version20250203105456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_commentaire CHANGE commentaire commentaire LONGTEXT DEFAULT NULL, CHANGE nom nom LONGTEXT DEFAULT NULL, CHANGE email email LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog_commentaire CHANGE commentaire commentaire TEXT DEFAULT NULL, CHANGE nom nom TEXT DEFAULT NULL, CHANGE email email TEXT DEFAULT NULL');
